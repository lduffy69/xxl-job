...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
                <span class="logo-mini"><img src="${request.contextPath}/static/img/kratos-jnns-logo.png" width="32" height="32"></span>
                <span class="logo-lg"><b style="font-size: 15px">${I18n.admin_name}</b></span>
		</a>
